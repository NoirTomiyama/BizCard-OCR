...
data class ImagesRequest(
    ...
    companion object {
        fun createSingleRequest(base64Image: String, type: Feature.Type, maxResults: Int = 10): ImagesRequest{
            val requests: List<AnnotateImageRequest> = listOf(AnnotateImageRequest(
                    Image(base64Image),
